...
const KnowHow = () => {
  ...
  const sliderData = [
    {
      id: 1,
      title: t("sliderKnowHow.slides.title"),
      slides: [
        t("sliderKnowHow.slides.content"),
      ],
      backgroundImage: "/assets/sections/fondKnowHow.webp",
  ...
  // Animation GSAP pour la section 2
  useEffect(() => {
  ...
  return (
      <div className="know-how-container w-full h-full">
        {/* Section 1: Slider de texte */}
        <section ref={section1Ref} className="h-screen bg-black text-white relative">
          <div
          ...
          >
            <div className="text-center z-10 w-full xl:max-w-[50vw] md:max-w-[60vw] sm:max-w-[90vw] px-6">
              <h2 className="text-gold font-yana text-4xl mb-6">
                {sliderData[currentStep]?.title}
              </h2>
              <div className="relative flex flex-col items-center justify-center">
                <p className="font-yana text-xl mb-6" style={{ whiteSpace: "pre-line" }}>
                  {sliderData[currentStep]?.description}
                </p>
                <div className="flex space-x-4 mt-4">
                  <button
                    onClick={() => handleSlideChange(-1)}
                    className="text-gold text-2xl hover:text-white"
