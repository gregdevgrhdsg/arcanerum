    ...
    sections: [
      {
        ...
        method: [
          { fr: "Secouez à sec tous les ingrédients.", en: "Dry-shake all ingredients." },
          { fr: "Filtrez dans un verre Nick & Nora refroidi.", en: "Strain into a chilled Nick & Nora glass." },
          { fr: "Servez sans garniture.", en: "Serve without garnish." },
        ],
      },
      {
        ...
        method: [
          { fr: "Combinez tous les ingrédients dans une casserole moyenne et portez à ébullition à feu vif.", en: "Combine all ingredients in a medium saucepan, and bring to a boil over high heat." },
    ...
    sections: [
      {
        ...
        method: [
          { fr: "Déposez une grande boule de sorbet à la pêche dans un verre de service moyen.", en: "Place 1 large scoop of peach sorbet into a medium serving glass." },
          { fr: "Secouez les autres ingrédients (sauf le vin pétillant).", en: "Shake the other ingredients (except the sparkling wine)." },
          { fr: "Complétez avec du vin pétillant sec et servez.", en: "Top with dry sparkling wine and serve." },
        ],
      },
      {
        ...
        ingredients: [
          ...
          { name: { fr: "Sirop de pistache", en: "Pistachio Syrup" }, qty: 156, unit: "g" },
          { name: { fr: "Sirop simple", en: "Simple Syrup" }, qty: 48, unit: "g" },
          { name: { fr: "Sel kasher", en: "Kosher Salt" }, qty: 1, unit: "g" },
        ],
        method: [
          { fr: "Mélangez tous les ingrédients dans un saladier et mélangez bien.", en: "Combine all ingredients thoroughly in a mixing bowl." },
          { fr: "Transférez dans un récipient hermétique et réfrigérez jusqu'à ce qu'il soit bien frais.", en: "Transfer to an airtight container and refrigerate until chilled." },
        ],
      },
      {
        ...
        ingredients: [
          ...
          { name: { fr: "Sucre", en: "Sugar" }, qty: 70, unit: "g" },
        ],
        method: [
          ...
          { fr: "Faites griller les pistaches pendant 10 à 12 minutes jusqu'à ce qu'elles dégagent leur parfum, en remuant de temps en temps.", en: "Toast the pistachios for 10-12 minutes until fragrant, stirring occasionally." },
      ...
      },
      {
        ...
        method: [
          { fr: "Mélangez le sucre et l'eau chaude dans un bol moyen.", en: "Combine sugar and hot water in a medium bowl." },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "The Arcane Extraroma 3 ans", en: "The Arcane Extraroma 3 yo" }, qty: 125, unit: "g" },
          { name: { fr: "Liqueur d'ananas Cartron", en: "Cartron Pineapple Liqueur" }, qty: 50, unit: "g" },
          { name: { fr: "Liqueur Cartron Cocody", en: "Cartron Cocody Liqueur" }, qty: 15, unit: "g" },
          { name: { fr: "Coco Lopez", en: "Coco Lopez" }, qty: 400, unit: "g" },
        ...
        method: [
          { fr: "Mixez tous les ingrédients jusqu'à obtenir une consistance lisse.", en: "Blend all ingredients until smooth." },
          { fr: "Servez dans un verre Pineapple Gold garni de noix de muscade fraîche râpée.", en: "Serve in a Pineapple Gold Glass with a grated fresh nutmeg garnish." },
        ],
      },
      {
        ...
        method: [
          ...
          { fr: "Découpez chaque quartier en quartiers d'environ 1,27 cm d'épaisseur.", en: "Slice each quarter into wedges about 1.27 cm thick." },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "The Arcane Extraroma 3 ans", en: "The Arcane Extraroma 3 yo" }, qty: 30, unit: "ml" },
          ...
          { name: { fr: "Ginger Beer très froide", en: "Ginger Beer, Very Cold" }, qty: 60, unit: "ml" },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "The Arcane Extraroma 12 yo", en: "The Arcane Extraroma 12 yo" }, qty: 360, unit: "g" },
          { name: { fr: "Sirop de mangue maison", en: "Homemade Mango Syrup" }, qty: 180, unit: "g" },
          { name: { fr: "Liqueur Cartron Triple Sec", en: "Cartron Triple Sec Liqueur" }, qty: 90, unit: "g" },
          { name: { fr: "Jus de citron vert frais", en: "Fresh Lime Juice" }, qty: 135, unit: "g" },
          { name: { fr: "Lait entier", en: "Whole Milk" }, qty: 180, unit: "g" },
          { name: { fr: "Base de Mango Milk Punch", en: "Mango Milk Punch Base Batch" }, qty: 160, unit: "ml" },
        ],
        method: [
          { fr: "Mélangez tous les ingrédients dans un bol moyen et remuez soigneusement.", en: "Combine all ingredients in a medium bowl and mix thoroughly." },
          { fr: "Transférez le mélange dans un récipient hermétique et laissez reposer à température ambiante pendant la nuit.", en: "Transfer the mixture to an airtight container and reserve at room temperature overnight." },
      ...
      },
      {
        ...
        method: [
          { fr: "Mélangez le sucre et le nectar de mangue dans un bol moyen.", en: "Combine sugar and mango nectar in a medium bowl." },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "The Arcane Extraroma 3 ans", en: "The Arcane Extraroma 3 yo" }, qty: 360, unit: "g" },
          { name: { fr: "Sirop de fruit de la passion maison", en: "Homemade Passion Fruit Syrup" }, qty: 180, unit: "g" },
          { name: { fr: "Liqueur Cartron Triple Sec", en: "Cartron Triple Sec Liqueur" }, qty: 90, unit: "g" },
          { name: { fr: "Jus de citron vert frais", en: "Fresh Lime Juice" }, qty: 135, unit: "g" },
          { name: { fr: "Lait entier", en: "Whole Milk" }, qty: 180, unit: "g" },
        ...
        method: [
          { fr: "Combinez tous les ingrédients dans un bol moyen, en remuant pour bien mélanger.", en: "Combine all ingredients in a medium bowl, stirring to mix thoroughly." },
          { fr: "Transférez dans un récipient hermétique et laissez reposer à température ambiante pendant la nuit.", en: "Transfer to an airtight container and reserve at room temperature overnight." },
      ...
      {
        title: { fr: "Sirop de fruit de la passion maison", en: "Homemade Passion Fruit Syrup" },
        ingredients: [
          { name: { fr: "Sucre", en: "Sugar" }, qty: 450, unit: "g" },
          { name: { fr: "Nectar de fruit de la passion", en: "Passion Fruit Nectar" }, qty: 450, unit: "g" },
        ],
        method: [
    ...
    sections: [
      ...
      },
      {
        ...
        ingredients: [
          ...
          { name: { fr: "Pisco", en: "Pisco" }, qty: 216, unit: "g" },
          { name: { fr: "Thé chai", en: "Chai Tea" }, qty: 8, unit: "g" },
          { name: { fr: "Cartron Pêche de Vigne", en: "Cartron Pêche de Vigne" }, qty: 32, unit: "g" },
          { name: { fr: "The Arcane Extraroma 3 ans", en: "The Arcane Extraroma 3 yo" }, qty: 208, unit: "g" },
        ],
        method: [
          ...
          { fr: "Laissez reposer pendant 30 minutes en remuant de temps en temps.", en: "Let sit for 30 minutes, stirring periodically." },
          { fr: "Dans une petite casserole, portez l'eau à ébullition légère et ajoutez le thé chai au mélange citron-sucre. Laissez infuser pendant 4 minutes.", en: "In a small saucepan, bring water to a simmer and add chai tea to the lemon-sugar mixture. Steep for 4 minutes." },
      ...
      },
      {
        ...
        ingredients: [
          ...
          { name: { fr: "Nectar de pêche", en: "Peach Nectar" }, qty: 450, unit: "g" },
          { name: { fr: "Sucre", en: "Sugar" }, qty: 80, unit: "g" },
          { name: { fr: "St-Germain Elderflower", en: "St-Germain Elderflower" }, qty: 60, unit: "g" },
          { name: { fr: "Eau", en: "Water" }, qty: 100, unit: "g" },
        ],
        method: [
          ...
          { fr: "Mélangez les épluchures et le sucre dans un bol en écrasant de temps en temps.", en: "Combine the peels and sugar in a bowl, muddling periodically." },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "Mélange de Sazerac à la banane fumée", en: "Smoked Banana Sazerac Batch" }, qty: 75, unit: "ml" },
          { name: { fr: "Absinthe verte", en: "Green Absinthe" }, qty: 7.5, unit: "ml" },
          { name: { fr: "Zeste d'orange frais", en: "Fresh Orange Peel" }, qty: 1, unit: "unité" }
        ],
        method: [
          ...
          { fr: "Inclinez et faites pivoter le verre pour enrober l'intérieur d'absinthe et le refroidir.", en: "Tilt and rotate the glass to coat the interior with absinthe and chill it." },
          { fr: "Videz le contenu du verre rincé à l'absinthe.", en: "Discard the contents of the absinthe-rinsed glass." },
      ...
      },
      {
        ...
        ingredients: [
          ...
          { name: { fr: "Liqueur de banane Cartron", en: "Cartron Banana Liqueur" }, qty: 62, unit: "g" },
          { name: { fr: "Liqueur au chocolat de Bob's", en: "Bob's Chocolate Liqueur" }, qty: 18, unit: "g" },
          { name: { fr: "Single Malt Laphroaig Select", en: "Laphroaig Select Single Malt" }, qty: 33, unit: "g" }
        ],
        method: [
          { fr: "Combinez tous les ingrédients dans un grand bol en remuant soigneusement pour bien mélanger.", en: "Combine all ingredients in a large bowl, stirring thoroughly to mix." },
    ...
    sections: [
      {
        title: { fr: "COCKTAIL PRINCIPAL", en: "MAIN COCKTAIL" },
        ingredients: [
          { name: { fr: "Base tropicale", en: "Tropical Stock" }, qty: 1000, unit: "g" },
          { name: { fr: "The Arcane Extraroma 3 ans", en: "The Arcane Extraroma 12 yo" }, qty: 175, unit: "g" },
          ...
          { name: { fr: "Sirop simple", en: "Simple Syrup" }, qty: 200, unit: "g" },
      ...
      },
      {
        ...
        method: [
          { fr: "Faites griller les clous de girofle et les bâtons de cannelle dans une casserole moyenne à feu vif jusqu'à ce qu'ils dégagent leur parfum.", en: "Toast cloves and cinnamon sticks in a medium saucepan over high heat until fragrant." },
      ...
      },
      {
        ...
        method: [
          { fr: "Préchauffez un grill à charbon ou à gaz à haute température.", en: "Preheat a charcoal or gas grill to high heat." },
    ...
    sections: [
      {
        ...
        method: [
          ...
          { fr: "Remuez jusqu'à refroidissement et dilution appropriée.", en: "Stir until chilled and properly diluted." },
          { fr: "Filtrez dans un verre Old Fashioned sur un bloc de glace au chocolat.", en: "Strain into an Old Fashioned glass over a chocolate clear ice block." },
